        ...
        {size?.width > 580 && (
          <div className="d-none d-md-block d-sm-block">
            <div className="section-box wow fadeInDown">
              <div style={{color: domain?.theme}} className="title">{isEn ? `WELFARE BENEFITS` : '福利待遇'}</div>
            </div>
          </div>
        )}
        {size?.width <= 580 && (
            ...
            >
              <div className="row-flex">
                <div className="row-item">
                  {size?.width <= 580 && (
                    <div className="d-block d-sm-none">
                      <div style={{color: domain?.theme}} className="title wow fadeInDown">{isEn ? `SALARY INCENTIVES` : '薪酬激励:'}</div>
                    </div>
                  )}
                  {size?.width >= 580 && (
                    <div style={{paddingTop: 50}} className="d-none d-md-block d-sm-block">
                      <div style={{color: domain?.theme}} className="title wow fadeInDown">{isEn ? `SALARY INCENTIVES` : '薪酬激励'}</div>
                    </div>
                  )}
              ...
              <div className="row-flex">
                <div className="row-item">
                  <div className="d-none d-md-block d-sm-block">
                    <div style={{color: domain?.theme}} className="title wow fadeInDown">{isEn ? 'THE WELFARE' : '福利'}</div>
                  </div>
                  <div className="text">
                    <div className="item-group">
                      <div className="item-box wow fadeInDown">
                        ...
                        <div className="type-box">
                          ...
                          <div style={{fontSize: 14,lineHeight: '16px'}} className="type-text">
                            {
                      ...
                      <div className="item-box wow fadeInDown">
                        ...
                        <div className="type-box">
                          ...
                          <div style={{fontSize: 14,lineHeight: '16px'}} className="type-text">{isEn ? `periodic occupational health examination` : `阶段性职业健康检查`}</div>
                        </div>
                      </div>
                      <div className="item-box wow fadeInDown">
                        <div className="icon-box">
                      ...
                      <div className="item-box wow fadeInDown">
                        ...
                        <div className="type-box">
                          ...
                          <div style={{fontSize: 14,lineHeight: '16px'}} className="type-text">{isEn ? 'we will organize travel activities for employees' : '组织员工旅游活动'}</div>
                        </div>
                      </div>
                      <div className="item-box wow fadeInDown">
                        <div className="icon-box">
