...
function About() {
  ...
  const {
    ...
    isFetching: aboutResultFetching,
    refetch: aboutResultRefetch
  } = useCompanyResult({language: getLanguage(), subtitleId: 11})
      ...
      <div className="content-main">
        ...
        <div className="container">
          <div className="section-box">
            ...
            <div dangerouslySetInnerHTML={{__html: aboutResult?.pc.introduction}} className="company-info">
